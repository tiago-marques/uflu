    ...
    return (
        <>
            <div className='flex flex-col space-y-48'>
                        ...
                        <div className='flex'>
                            <div className='flex-1 sm:basis-2/5 sm:flex-1'>
                                ...
                                <p className='leading-normal mt-4 text-xl w-1/2'>
                                    <b>Conecte-se</b> a uma nova forma de
                                    vender, transformando suas vendas em uma
                                    venda insta-fácil, insta-rápido e para{' '}
                                    <br />
                                    <b>+15 países.</b>
                                </p>
                ...
                <section className='flex flex-col items-end p-4 bg-white mx-auto space-y-32'>
                    ...
                    <div className='flex sm:flex-row max-w-xl justify-center'>
                        ...
                        <div className='w-full sm:w-1/2'>
                            <div className='align-middle'>
                                ...
                                <p className='text-gray-600 mb-8'>
                                    <br />
                                    Estamos preparados para que seu negócio
                                    aceite <b>
                    ...
                    <div className='flex sm:flex-row-reverse max-w-xl justify-center'>
                        ...
                        <div className='w-full sm:w-1/2'>
                            <h3 className='text-3xl text-gray-800 font-bold leading-none mt-3'>
                                Receba em sua moeda local
                            </h3>
                            <p className='text-gray-600 mb-8'>
                                <br />
                                Mesmo vendendo para exterior{' '}
                                <b>
                                    o preço de venda é convertido para sua moeda
                                    local
                                </b>
                                .
                                <br />
